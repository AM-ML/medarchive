...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md py-6 px-6 text-sm font-medium " +
    "hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground " +
    "disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-accent/50 data-[state=open]:text-accent-foreground " +
    "focus-visible:ring-ring/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1 hook123"
);
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        "data-[motion=from-end]:slide-in-from-left-52 data-[motion=from-start]:slide-in-from-right-52 " +
        "data-[motion=to-end]:slide-out-to-left-52 data-[motion=to-start]:slide-out-to-right-52 " +
        "top-0 right-0 w-full p-2 pr-2.5 md:absolute md:w-auto md:left-auto",

        // viewport = false customizations
...
function NavigationMenuViewport({
  ...
  return (
    <div className="absolute top-full left-0 isolate z-[5000] flex justify-center">
    ...
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "data-[active=true]:focus:bg-accent data-[active=true]:hover:bg-accent data-[active=true]:bg-accent/50 " +
          ...
          "flex flex-col gap-1 rounded-sm p-4 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1",
        className
      )}
      {...props}
    />
    ...
    <NavigationMenuPrimitive.Indicator
      ...
      className={cn(
        "data-[state=visible]:animate-in data-[state=hidden]:animate-out " +
          ...
          "top-full z-[5000] flex h-1.5 items-end justify-center overflow-hidden",
        className
      )}
      {...props}
    >
